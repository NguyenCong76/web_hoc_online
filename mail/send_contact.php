...
require 'vendor/autoload.php';
 class contact_us
 {
    public function contact($title,$content,$addressMail)
    {
        $mail = new PHPMailer(true);
                try {
                    ...
                    //Recipients
                    $mail->setFrom('thaihung11092001@gmail.com', 'Người dùng có thông tin cần hệ thống hỗ trợ.');
                ...
                $mail->addCC('thaihung11092001@gmail.com');
                   ...
                   // $mail->AltBody = 'This is the body in plain text for non-HTML mail clients';
                    $mail->send();
                    echo"<script>alert('Bạn đã gửi thành công yêu cầu hỗ trợ về hệ thống.')</script>";
                } catch (Exception $e) {
